...
public class Subtraction
{
	...
	public void Subtract_Invalid_Patino()
	{
		...
		Assert.ThrowsException<FormatException>(() => Program.Subtract("c", "d"));
	}
	...
	public class Multiplication
	{
		...
		{
			Assert.ThrowsException<FormatException>(() => Program.Multiply("1", "e"));
			Assert.ThrowsException<FormatException>(() => Program.Multiply("f", "1"));
			Assert.ThrowsException<FormatException>(() => Program.Multiply("g", "h"));
		}
	...
	public class Division
	{
		...
		{
			Assert.ThrowsException<FormatException>(() => Program.Divide("1", "i"));
			Assert.ThrowsException<FormatException>(() => Program.Divide("j", "1"));
			Assert.ThrowsException<FormatException>(() => Program.Divide("k", "l"));
		}
